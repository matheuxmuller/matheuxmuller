...
- :computer: Back-end com Java 8, utilizando Spring Boot para a criação de RESTful APIs com JPA Hibernate, build em Maven e protocolo básico de segurança no armazenamento e encriptação dos dados de acesso dos usuários
