...
<p> Como um iniciante na área, gosto muito de descobrir como melhorar o meu dia-a-dia programando, desde IDEs e editores de texto a novas linguagens. Meu principal interesse na área é aprender sobre <b>desenvolvimento de aplicativos</b> (tanto para Android, quanto iOS) e, pensando nisso, estou cursando técnico em <b> Informática para Internet na ETEC SEBRAE </b>, que trabalha com as linguagens C, C#, C++, Java e JavaScript, além de HTML, CSS e banco de dados SQL/NoSQL, e tem esse foco específico. <p>
